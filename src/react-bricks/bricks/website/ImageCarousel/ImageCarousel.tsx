...
const NextArrow: React.FC<ArrowProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="absolute cursor-pointer bg-pink-50 w-10 h-10 border border-pink-400 rounded-full z-10"
      style={{ top: '50%', right: '10px', zIndex: '1' }}
    >
...
const PreviousArrow: React.FC<ArrowProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="absolute cursor-pointer bg-pink-50 w-10 h-10 border border-pink-400 rounded-full z-10"
      style={{ top: '50%', left: '10px', zIndex: '1' }}
    >
