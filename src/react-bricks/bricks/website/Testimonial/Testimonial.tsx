...
Testimonial.schema = {
  ...
  getDefaultProps: () => ({
    quote:
      'Wykwalifikowana firma, która pomogła nam zdefiniować wymagania aplikacji do zarządzania produkcją i wdrożyła ją jako piękny system, który uwielbiają nasi użytkownicy. Jesteśmy bardzo zadowoleni.',
    authorName: 'Jan Kowalski',
    authorJobTitle: 'Założyciel strony',
    avatarImage: {
