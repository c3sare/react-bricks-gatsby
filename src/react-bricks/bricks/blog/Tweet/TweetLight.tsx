  ...
  sideEditProps: [
    {
      ...
      component: () => (
        <div className="text-sm">
          To jest uproszczona wersja bloku treści Tweeta: nie ładuje on Twittera
          JavaScript, więc jest znacznie lepszy pod względem wydajności, ale
          wymaga ręcznego wprowadzenia treści i właściwości Tweeta.
        </div>
      ),
    },
    {
